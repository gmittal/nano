---START_METADATA---
{
  "title": "One Minute Jazz Lessons",
  "author": "Gautam Mittal",
  "summary": "Part II of the infamous Joey Alexander dynasty.",
  "tags":[
    "awesome",
    "jazzy"
  ]
...
Once upon a time, there was a ```lorem ipsum```. It hacked into Joey Alexander's vault only to find the source code to the greatest blogging software ever.
...
The lorem ipsum lived happily ever after.
